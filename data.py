...
valueDescriptors =  [ValueDescriptor("Input Register", 13, "Actual system output", "%"),
                     ...
                     ValueDescriptor("Input Register", 22, "EEV compressor 1", "h"),
                     ValueDescriptor("Input Register", 23, "EEV compressor 2", "h"),
                     ValueDescriptor("Input Register", 24, "Elec. heating stage 1", "h"),
                     ValueDescriptor("Input Register", 25, "Elec. heating stage 2", "h"),
                     ...
                     ValueDescriptor("Input Register", 100, "System flow temp", "deg.C"),
                     ValueDescriptor("Input Register", 101, "System flow temp", "deg.C"),
                     ...
                     ValueDescriptor("Input Register", 121, "Set room temperature", "deg.C"),
                     ...
                     ValueDescriptor("Discrete Input", 5, "Electric heating stage 1", "None"),
                     ValueDescriptor("Discrete Input", 6, "Electric heating stage 2", "None"),
